...
from .SliceVars import SliceDef
...
class TaskForm ( QtWidgets.QWidget ):
    ...
    input_1_curapath : QtWidgets.QLineEdit
    input_1_POSX : QtWidgets.QDoubleSpinBox
    input_2_POSY : QtWidgets.QDoubleSpinBox
    input_3_POSZ : QtWidgets.QDoubleSpinBox
    Group_5_OPP : QtWidgets.QGroupBox
    input_2_FILDIA : QtWidgets.QDoubleSpinBox
    input_1_NOZDIA : QtWidgets.QDoubleSpinBox
    input_0_FLH : QtWidgets.QDoubleSpinBox
    input_1_LH : QtWidgets.QDoubleSpinBox
    input_2_PS : QtWidgets.QSpinBox
    input_3_SBL : QtWidgets.QSpinBox
    input_4_STL : QtWidgets.QSpinBox
    input_5_DN : QtWidgets.QSpinBox
    input_6_EF : QtWidgets.QSpinBox
    input_1_LFR : QtWidgets.QSpinBox
    input_2_RFR : QtWidgets.QSpinBox
    input_3_IFR : QtWidgets.QSpinBox
    input_4_FLFR : QtWidgets.QSpinBox
    input_5_MLT : QtWidgets.QSpinBox
    input_1_NT : QtWidgets.QSpinBox
    input_2_BT : QtWidgets.QSpinBox
    Group_0_EnableFan : QtWidgets.QGroupBox
    input_1_MinFS : QtWidgets.QSpinBox
    input_2_MaxFS : QtWidgets.QSpinBox
    slider_1_MinFS : QtWidgets.QSlider
    slider_2_MaxFS : QtWidgets.QSlider
    input_1_MSAH : QtWidgets.QSpinBox
    Group_1_EnableExtruderRetract : QtWidgets.QGroupBox
    input_1_ERA : QtWidgets.QDoubleSpinBox
    input_2_ERFR : QtWidgets.QSpinBox
    input_3_ERMD : QtWidgets.QDoubleSpinBox
    input_4_ERME : QtWidgets.QDoubleSpinBox
    checkbox_1_EC : QtWidgets.QCheckBox
    Group_2_EnableSkirt : QtWidgets.QGroupBox
    input_1_DIST : QtWidgets.QSpinBox
    input_2_LC : QtWidgets.QSpinBox
    input_3_ML : QtWidgets.QSpinBox
    Group_3_EnableSupport : QtWidgets.QGroupBox
    radioButton_2_EE : QtWidgets.QRadioButton
    radioButton_1_ETB : QtWidgets.QRadioButton
    input_0_SD : QtWidgets.QSpinBox
    input_1_SXYD : QtWidgets.QDoubleSpinBox
    input_2_SZD : QtWidgets.QDoubleSpinBox
    Group_4_EnableRaft : QtWidgets.QGroupBox
    input_1_RMG : QtWidgets.QDoubleSpinBox
    input_2_RLS : QtWidgets.QDoubleSpinBox
    input_3_RBT : QtWidgets.QDoubleSpinBox
    input_4_RBLW : QtWidgets.QDoubleSpinBox
    input_5_RIT : QtWidgets.QDoubleSpinBox
    input_6_RILW : QtWidgets.QDoubleSpinBox
    checkbox_1_SPI : QtWidgets.QCheckBox
    textEdit_startcode : QtWidgets.QTextEdit
    textEdit_endcode : QtWidgets.QTextEdit
    button_1_filediag : QtWidgets.QToolButton
    button_1_ES : QtWidgets.QPushButton
    button_2_IS : QtWidgets.QPushButton
...
class SlicerPanel:
    ...
    def __init__(self):
        ...
        file = path.join(path.dirname(__file__),'Slicer.ui')
    ...
    def accept(self):
        ...
        docDir = actDoc.FileName.replace(docName + ".fcstd", "")
        partList = Gui.Selection.getSelection()
    ...
    def chooseOutputDir(self):
        ...
        fileName, _ = QtWidgets.QFileDialog.getOpenFileName(None, 'Locate CuraEngine', self.Vars.readMisc("CuraPath"))
        if(fileName):
    ...
    def exportSettingsFile(self):
        ...
        fileName, _ = QtWidgets.QFileDialog.getSaveFileName(None, 'Save Settings File', self.Vars.readMisc("SettingsPath"))
        if(fileName):
    ...
    def importSettingsFile(self):
        ...
        fileName, _ = QtWidgets.QFileDialog.getOpenFileName(None, 'Select Settings File', sett, "CuraEngine Settings File .ces (*.ces)")
    ...
    def GetXYZPos(self, partsList):
        if len(partsList) == 1:
            ...
            f = document.addObject("Part::MultiFuse","Fusion")
            f.Shapes = partsList
            # Must recompute first to get correct boundbox
            document.recompute()
            bb = f.Shape.BoundBox
            # Delete the temp fusion
            document.removeObject(f.Name)
        c = bb.Center
